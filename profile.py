...
# Clone your GitHub repo (forcing the use of main branch into /home/Stock-Trader-Aider)
node.addService(rspec.Execute(shell="/bin/sh", command="git clone --branch main https://github.com/JustinKerr401/Stock-Trader-Aider.git /home/Stock-Trader-Aider"))
